  ...
  return (
    <div className="ap-screen" style={{ flex: 1, minHeight: 0, overflowY: 'auto', background: '#F2EDE6' }}>
      <div style={{ padding: '64px 22px 20px', background: 'linear-gradient(160deg, #F2EDE6, #FFFFFF)' }}>
        ...
        <div style={{ marginTop: 10, fontSize: 13, lineHeight: 1.6, color: '#2F4A3F', maxWidth: 290, textWrap: 'pretty' }}>Three friends have described you. What they see shapes who we look for.</div>
      </div>
      <div style={{ padding: '4px 22px 26px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        {STATIC_FRIENDS.map((f) => (
          <div key={f.name} style={{ padding: '18px 20px', borderRadius: 20, background: '#FFFFFF', border: '1px solid rgba(166,154,205,.18)' }}>
