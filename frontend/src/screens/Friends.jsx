...
export default function Friends() {
  return (
    <div className="ap-screen" style={{ flex: 1, minHeight: 0, overflowY: 'auto', background: '#FBF9F6' }}>
      <div style={{ padding: '64px 22px 20px', background: 'linear-gradient(160deg, #F2EDE6, #FBF9F6)' }}>
      ...
      <div style={{ padding: '4px 22px 26px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ padding: 20, borderRadius: 20, background: 'linear-gradient(140deg, #EFECF7, #DDEAE6)' }}>
