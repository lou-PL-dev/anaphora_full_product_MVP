      ...
      <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 10 }}>
        {discoveries.map((d) => (
          <button
            ...
            style={{ width: '100%', textAlign: 'left', padding: 18, borderRadius: 20, border: `1px solid ${d.done ? '#DDEAE6' : 'rgba(47,74,63,.10)'}`, background: d.done ? '#DDEAE6' : '#FFFFFF', cursor: 'pointer' }}
          >
