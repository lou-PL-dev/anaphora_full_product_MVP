    ...
    <div className="ap-screen" style={{ flex: 1, minHeight: 0, overflowY: 'auto', background: '#FFFFFF', padding: '64px 22px 24px' }}>
      ...
      <button onClick={resumeConversation} style={{ marginTop: 22, width: '100%', textAlign: 'left', padding: 20, borderRadius: 20, border: '1px solid rgba(47,74,63,.1)', background: '#FFFFFF', cursor: 'pointer' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}><div style={{ fontSize: 14, color: '#2F4A3F' }}>The person you'd love to meet</div><div style={{ marginTop: 3, fontSize: 11.5, color: '#94A09A' }}>{convoStatus}</div></div>
      ...
      <button onClick={startDiscovery} style={{ marginTop: 10, width: '100%', textAlign: 'left', padding: 20, borderRadius: 20, border: 'none', background: 'linear-gradient(140deg, rgba(166,154,205,.16), #DDEAE6)', cursor: 'pointer' }}>
        <div style={{ fontSize: 10, letterSpacing: '.14em', color: '#A69ACD' }}>4 QUESTIONS · 2 MIN</div>
