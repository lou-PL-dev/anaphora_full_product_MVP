  ...
  return (
    <div className="ap-screen" style={{ flex: 1, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '42px 32px 44px', background: 'linear-gradient(170deg, #F2EDE6 0%, #FFFFFF 48%, #DDEAE6 100%)' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <button onClick={onBegin} style={{ marginTop: 30, width: '100%', padding: 17, border: 'none', borderRadius: 999, background: '#2F4A3F', color: '#FFFFFF', fontSize: 15, fontWeight: 500, letterSpacing: '.01em', cursor: 'pointer', boxShadow: '0 10px 26px rgba(166,154,205,.24)' }}>Begin</button>
