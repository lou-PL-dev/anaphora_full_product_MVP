  ...
  return (
    <div className="ap-screen" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, background: '#FFFFFF' }}>
      ...
      <div style={{ padding: '10px 16px 18px', borderTop: '1px solid rgba(47,74,63,.07)', display: 'flex', gap: 10, alignItems: 'flex-end', background: '#FFFFFF' }}>
        ...
        {voiceSupported && <button onClick={handleMicClick} title={listening ? 'Stop dictation' : 'Describe it out loud'} style={{ flex: 'none', width: 46, height: 46, borderRadius: '50%', border: listening ? 'none' : '1px solid rgba(47,74,63,.14)', background: listening ? '#A69ACD' : '#FFFFFF', color: listening ? '#FFFFFF' : '#5C6B62', cursor: 'pointer', display: 'grid', placeItems: 'center', animation: listening ? 'apPulse 1.4s ease-out infinite' : 'none' }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}><path d="M12 15a3 3 0 0 0 3-3V6a3 3 0 0 0-6 0v6a3 3 0 0 0 3 3Z" /><path d="M19 11a7 7 0 0 1-14 0" /><line x1="12" y1="19" x2="12" y2="22" /></svg></button>}
