    ...
    <div className="ap-screen" style={{ flex: 1, minHeight: 0, overflowY: 'auto', background: '#FBF9F6' }}>
      ...
      <div style={{ padding: '4px 22px 24px', display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div style={{ padding: 20, borderRadius: 20, background: '#DDEAE6' }}>
          ...
          <div style={{ marginTop: 8, fontSize: 13, lineHeight: 1.6, color: '#4A5C53' }}>Every conversation, Discovery and friend contribution refines it. Nothing here is fixed.</div>
          <button onClick={goHome} style={{ marginTop: 16, padding: '13px 22px', border: 'none', borderRadius: 999, background: '#2F4A3F', color: '#F2EDE6', fontSize: 13.5, fontWeight: 500, cursor: 'pointer' }}>Looks right — continue</button>
        </div>
      </div>
    </div>
  );
